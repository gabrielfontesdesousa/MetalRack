export default function SpecificationsArea() {
  return (
    <div className="bg-gradient-to-b from-black to-[#1B1B1B] h-auto   bg-black w-full flex justify-center ">
      <div className="">
        <div className="flex max-w-[100%] justify-center items-center pt-[100px]">
          <div className="flex flex-col justify-center items-center gap-3">
            <img className="w-[15%] filter blur-sm brightness-75" src="./src/assets/checkedicon.svg" alt="" />
        ...
        <div className="flex max-w-[100%] justify-center items-center py-[100px]">
          <div className="flex flex-col justify-center items-center gap-3">
            <img className="w-[15%] filter blur-sm brightness-75" src="./src/assets/checkedicon.svg" alt="" />
            <h1 className="text-3xl md:text-5xl font-bold leading-tight text-left " style={{ fontFamily: "MontSerrat, sans-serif" }}>
              <span className="relative text-white text-[30px]">
      ...
      <img className="w-[30%]" src="./src/assets/rackimage.svg" alt="" />
